...
:LAST_MODIFIED: [2023-08-21 Mon 05:47]
...
|        1 | 2.05 |   4 |    12.57 | 2023-08-24T12:49:45Z |
:END:
...
| position | ease | box | interval | due                  |
|----------+------+-----+----------+----------------------|
|        0 |  2.5 |  -1 |        0 | 2023-08-21T12:47:18Z |
|        1 |  2.5 |  -1 |        0 | 2023-08-28T12:47:18Z |
:END:

{{$'F(x)$}@0} $=$ {{$F(x) = \int_a^x f(t)dt$, where $x$ is in $[a,b]$}@1}
